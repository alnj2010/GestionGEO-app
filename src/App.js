            ...
            <Switch>
                ...
                <Menu>
                    <Switch>
                        ...
                        <Route
                            exact
                            path="/programas-academicos/create"
                            component={SchoolProgramDetail}
                        />
                        ...
                        <Route
                            exact
                            path="/periodo-semestral/actual"
                            component={SchoolPeriodActual}
                        />
                        <Route
                            exact
                            path="/periodo-semestral/list"
                            component={SchoolPeriodsList}
                        />
                        <Route
                            exact
                            path="/periodo-semestral/edit/:id"
                            component={SchoolPeriodDetail}
                        />
                        <Route
                            exact
                            path="/periodo-semestral/create"
                            component={SchoolPeriodDetail}
                        />
                        <NotFound />
                    </Switch>
