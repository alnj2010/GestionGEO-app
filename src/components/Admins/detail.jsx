              ...
              <RenderFields>
                {[
                  ...
                  },
                  {
                    ...
                    type: "select",
                    options: [
                      { key: "SECRETARIO", value: "SECRETARY" },
                      { key: "COORDINADOR", value: "COORDINATOR" }
                    ].map(type => {
                  ...
                  },
                  {
                    ...
                    options: [
                      ...
                      { value: "DOCTOR", id: "Dr" },
                      { value: "ESPECIALISTA", id: "Esp" },
                      { value: "INGENIERO", id: "Ing" },
                      { value: "MAGISTER SCIENTIARUM", id: "MSc" },
                      { value: "LICENCIADO", id: "Lic" }
                    ].map(type => {
                      return { key: type.value, value: type.id };
                    })
                  },
                  {
                    label: "Nacionalidad",
                  ...
                  },
                  {
                    ...
                    field: "principal",
                    id: "principal",
                    type: isMain && rol !== "SECRETARY" ? "switch" : "hidden"
                  }
                ]}
              </RenderFields>
            </Grid>
