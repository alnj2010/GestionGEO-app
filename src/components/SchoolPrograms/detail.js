                        ...
                        <Grid container justify="space-between">
                            <RenderFields>
                                {[
                                    ...
                                    {
                                        label:
                                            'Minimo de UC para presentar la TEG',
                                    ...
                                    {
                                        label:
                                            'Minimo de semestres para presentar la TEG',
                                        field: 'minDuration',
                                        id: 'minDuration',
                                        type: 'number',
                                        min: 1,
...
SchoolProgramDetail = connect(
    (state) => ({
        initialValues: {
            schoolProgramName: state.schoolProgramReducer.selectedSchoolProgram
                .school_program_name
            ...
            duration: state.schoolProgramReducer.selectedSchoolProgram.duration
                ...
                : '',
            minNumCuFinalWork: state.schoolProgramReducer.selectedSchoolProgram
                .min_num_cu_final_work
                ? state.schoolProgramReducer.selectedSchoolProgram
                      .min_num_cu_final_work
                : '',
            minDuration: state.schoolProgramReducer.selectedSchoolProgram
                .min_duration
                ? state.schoolProgramReducer.selectedSchoolProgram.min_duration
                : '',
            grantCertificate: state.schoolProgramReducer.selectedSchoolProgram
                .grant_certificate
                ? state.schoolProgramReducer.selectedSchoolProgram
                      .grant_certificate
                : false,
